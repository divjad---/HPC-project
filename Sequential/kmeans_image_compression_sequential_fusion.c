...
void kmeans_image_compression(unsigned char *imageIn, int width, int height, int cpp, int fusion) {
    int num_pixels = width * height;
...
int main(int argc, char **argv)
{
    ...
    kmeans_image_compression(input_image, width, height, cpp, fusion);
